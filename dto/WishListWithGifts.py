class WishListWithGifts:
    def __init__(self, wish_list_id, user_group_id, gift_id, name_gift):
        self._wish_list_id = wish_list_id
        self._user_group_id = user_group_id
        self._gift_id = gift_id
        self._name_gift = name_gift
    ...
    @property
    def name_gift(self):
        return self._name_gift

    @name_gift.setter
    def name_gift(self, name_gift):
        self._name_gift = name_gift
